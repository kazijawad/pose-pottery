var app = (function () {
    ...
    var css_248z$2 = "section.svelte-1bkagza{display:flex;flex-direction:column;align-items:center;justify-content:center;grid-column:1 / 7;border:0.1rem solid var(--c-black)}canvas.svelte-1bkagza{display:none}button.svelte-1bkagza{margin-top:1rem;padding:1rem;font-size:2rem;border:0.1rem solid var(--c-black);border-radius:0.2rem;background-color:var(--c-off-white);color:var(--c-black);transition:all 0.3s}button.svelte-1bkagza:hover{background-color:var(--c-black);color:var(--c-white)}";
    ...
    function create_fragment$2(ctx) {
        ...
        <track kind="captions"/>`;
    			...
    			attr(button, "class", "svelte-1bkagza");
    			attr(canvas_1, "class", "svelte-1bkagza");
    			attr(section, "class", "svelte-1bkagza");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(video_1, "canplay", /*handleCanPlay*/ ctx[3]),
    					listen(button, "click", prevent_default(/*handleClick*/ ctx[4]))
    				];
    ...
    var css_248z$1 = "section.svelte-15p87q5{display:flex;flex-direction:column;align-items:center;justify-content:center;grid-column:7 / -1;border:0.1rem solid var(--c-black);border-left:none}img.svelte-15p87q5{height:512px;width:100%;object-fit:contain}";
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(img, "class", "svelte-15p87q5");
    			attr(section, "class", "svelte-15p87q5");
    		},
    		m(target, anchor) {
    			insert(target, section, anchor);
    			append(section, img);
